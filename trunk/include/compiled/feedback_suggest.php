    ...
    <div id="content" class="help">
        <div class="box">
            ...
            <div class="box-content">
                ...
                <div class="sect">
                          <p class="notice">Your suggetion is very important to us, please leave your feedback here.</p>
                    <form id="feedback-user-form" method="post" action="/feedback/suggest.php" class="validator">
                        ...
                        <div class="field email">
                            ...
                            <span class="hint">Leave your Email, MSN or cellphone number here.</span>
                        </div>
                        <div class="field suggest">
                            <label for="feedback-suggest">Content</label>
