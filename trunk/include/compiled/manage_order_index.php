    ...
    <div id="content" class="coupons-box clear mainwide">
		<div class="box clear">
            ...
            <div class="box-content">
                <div class="head">
                    <h2>Current Order</h2>
					<ul class="filter"><li><form action="/manage/order/index.php" method="get">User's Email：<input type="text" name="uemail" class="h-input" value="<?php echo htmlspecialchars($uemail); ?>" >&nbsp;<input type="submit" value="Filter" class="formbutton"  style="padding:1px 6px;"/><form></li>
					</ul>
				</div>
                <div class="sect">
					...
					<tr <?php echo $index%2?'':'class="alt"'; ?> id="order-list-id-<?php echo $one['id']; ?>">
						...
						<td class="op"><?php if($one['state']=='pay'){?><a href="/ajax/manage.php?action=orderview&id=<?php echo $one['id']; ?>" class="ajaxlink">Detail</a><?php } else if($one['state']=='unpay') { ?><a href="/ajax/manage.php?action=ordercash&id=<?php echo $one['id']; ?>" class="ajaxlink" ask="Confirm this order will be paid by cash? ">Cash?</a><?php }?></td>
					</tr>
					<?php }}?>
