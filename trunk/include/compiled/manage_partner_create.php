	...
	<div id="content" class="clr mainwide">
        <div class="clr box">
            ...
            <div class="box-content">
                <div class="head"><h2>Create New Partner</h2></div>
                <div class="sect">
                    <form id="login-user-form" method="post" action="/manage/partner/create.php">
                        ...
                        <div class="field">
                            ...
                            <div style="float:left;"><textarea cols="45" rows="5" name="location" id="partner-create-location" class="xheditor-simple"></textarea></div>
						</div>
                        <div class="field">
                            <label>Other Info</label>
                            <div style="float:left;"><textarea cols="45" rows="5" name="other" id="partner-create-other" class="xheditor-simple"></textarea></div>
						</div>
