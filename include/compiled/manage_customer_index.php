...
<div id="coupons">
	<div class="dashboard" id="dashboard">
		<ul><?php echo mcurrent_customer('index'); ?></ul>
	</div>
		...
		<div class="box clr">
            ...
            <div class="box-content">
                <div class="head">
                    <h2>User List</h2>
                    <ul class="filter">
						<li><form action="/manage/customer/index.php" method="get">Email: <input type="text" name="like" class="h-input" value="<?php echo htmlspecialchars($like); ?>" >&nbsp;<input type="submit" value="Filter" class="formbutton"  style="padding:1px 6px;"/><form></li>
					</ul>
				</div>
                <div class="sect">
