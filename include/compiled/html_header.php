...
<body onload="MM_preloadImages('<?php echo $ajax_root; ?>/static/images/daily-deals-hvr.jpg','<?php echo $ajax_root; ?>/static/images/past-deals-hvr.jpg','/static/images/how-moosavings-works-hvr.jpg','<?php echo $ajax_root; ?>/images/discussion-hvr.jpg')">
