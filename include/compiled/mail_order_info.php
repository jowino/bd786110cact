        ...
        <div id='mail-header' style='height:104px; margin: 0; -moz-border-radius-topright:8px; -moz-border-radius-topleft:8px; -webkit-border-top-right-radius:8px; -webkit-border-top-left-radius:8px; border-bottom:4px solid #338888;'>
            <table bgcolor='#2d2d2d' cellpadding='0' cellspacing='0' height='104px' width='670px'>
                <tr>
                    ...
                    <td width="250" style='padding-left:15px; padding-top:38px;text-align:center;color:#FFF;font-weight:bold;' valign='top'><?php echo $city['name']; ?></td>
...
<table cellpadding='0' cellspacing='0' width='100%'>
    ...
    <tr>
        <td colspan='2' style="padding: 0 20px 20px 20px;">
            <h1 style='margin:0; padding:0; line-height:1.2; '><a href="<?php echo $INI['system']['wwwprefix']; ?>/team.php?id=<?php echo $team['id']; ?>" style="text-decoration:none; font-size:30px; font-weight:700; font-family:Helvetica, Arial, sans-serif;; margin:0;" title="<?php echo $team['title']; ?>"><?php echo $team['title']; ?></a></h1>
        </td>
    </tr>
    <!-- TR 2 -->
    <tr>
