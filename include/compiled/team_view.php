...
<?php if($team['state']=='none'){?>
			...
			deal to tip. <a href="#">Learn more</a><br /></p>
				...
				<p><a href="/team/buy.php?id=<?php echo $team['id']; ?>&action=buyforfriend">Buy it for a friend!</a></p>
